...
<div class="bg-white text-black p-6 rounded-2xl shadow-xl mb-6">
    <form method="POST" action="{{ route('profiles.store') }}" class="space-y-4">
        ...
        <input type="text" name="program" placeholder="Program" class="w-full p-3 border rounded-lg" required>
        ...
        <textarea name="bio" placeholder="Short Bio" class="w-full p-3 border rounded-lg" required></textarea>
